...
export const ModalDeleteAd = ({ isOpen, onClose }: ModalProps) => {
        ...
        <ModalContent mt="100px" as="form" fontFamily="Lexend" zIndex="10000">
          ...
          <ModalBody display="flex" flexDirection="column" gap="20px">
            ...
            <TextB1 fontWeight={400} color={Colors.grey3}>
              Essa ação não pode ser desfeita. Isso excluirá permanentemente seu anúncio.
            </TextB1>
          </ModalBody>
          <ModalFooter gap="10px">
            <ButtonGray6 onClick={onClose}>Cancelar</ButtonGray6>
            <ButtonAlert3 onClick={() => announcementDelete()} isDisabled={false} type="submit">
